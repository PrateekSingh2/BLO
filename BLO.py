...
home_bg_img=PhotoImage(file="BLO\directory\Images\home_bg.png")
username_img=PhotoImage(file="BLO\directory\Images\\username.png")
password_img=PhotoImage(file="BLO\directory\Images\passwd.png")
verify_img=PhotoImage(file="BLO\directory\Images\confirm.png")
part_img=PhotoImage(file="BLO\directory\Images\part.png")
name_img=PhotoImage(file="BLO\directory\Images\\name.png")
profile_img=PhotoImage(file="BLO\directory\Images\profile.png")
eci_img=PhotoImage(file="BLO\directory\Images\eci.png")
satya_img=PhotoImage(file="BLO\directory\Images\satya.png")
card_bg=PhotoImage(file="BLO\directory\Images\card_bg_img.png")
gov_img=PhotoImage(file="BLO\directory\Images\gov_img.png")
...
def main_menu():
    ...
    chng_geo_bg()
    logout_btn=Button(root,text="Logout",command=logout,font=('Calibri','14'),bg="#d7b33e",bd=0)
    logout_btn.place(x=735,y=15)
    profile_pic_image=Label(root,image=profile_img,bg='#b59332')
    profile_pic_image.place(x=3,y=3)
    disp_us=Label(root,text=user_name,font=('Calibri','15','bold'),bg='#b59332')
    disp_us.place(x=53,y=16)
    footer=Label(root,text='Designed & Developed by Prateek',font=('Calibri','10','bold'),bg="#fdce8a")
    footer.place(x=658,y=581)
